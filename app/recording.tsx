...
export default function Recording() {
	...
	const isNoiseReductionOn = noiseReductionMethod !== 'none';
	const noiseRemovalStatusColor = isNoiseReductionOn ? "#3DC13C" : "#FF2121";
	const noiseRemovalTextColor = isNoiseReductionOn ? "text-success" : "text-danger";
					...
					<View className="gap-2">
						...
						<View className="flex flex-row justify-between items-center">
							...
							>
								...
								>
									{isNoiseReductionOn
										? noiseReductionMethod === 'wiener' ? 'Wiener' : 'DeepFilterNet'
										: "OFF"
									}
								</Text>
							</TouchableOpacity>
