      ...
      >
        <View className="gap-5">
          <View className="gap-2 py-5">
            <Text className={currentText + " font-publicsans"}>General</Text>
            <View className={currentLayer + " p-4 rounded-lg gap-5 shadow-md"}>
              <View className="flex flex-row justify-between items-center">
                ...
                <Switch
                  trackColor={{
                    false: currentTheme === "dark" ? "#808080" : "#ccc",
                    true: "#006fff", // active color
                  }}
                  thumbColor={currentTheme === "dark" ? "#eee" : "#fff"}
                />
              </View>
              <View className="flex flex-row justify-between items-center">
                <Text className={currentText + " font-publicsans"}>
          ...
          <View className="gap-2">
            <Text className={currentText + " font-publicsans"}>UI Mode</Text>
            <SettingButton
              title="Light"
              icon="light-up"
              onPress={() => {}}
